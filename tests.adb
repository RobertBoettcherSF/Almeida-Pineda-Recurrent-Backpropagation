...
procedure Tests is
   ...
   Net1      : Network (Size => 1);
   Net2      : Network (Size => 2);
   Vec1      : constant Vector (1 .. 1) := [others => 0.0];
   Vec2      : constant Vector (1 .. 2) := [0.0, 0.0];
   Vec3      : constant Vector (1 .. 3) := [0.0, 0.0, 0.0];
   Bool2     : constant Boolean_Vector (1 .. 2) := [False, False];
   Bool3     : constant Boolean_Vector (1 .. 3) := [False, False, False];
   Converged : Boolean;
   Success   : Boolean;
   Caught    : Boolean;
begin
